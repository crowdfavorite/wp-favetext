...
?>
			<p id="developer-link"><?php printf(__('<a href="http://crowdfavorite.com/wordpress/themes/faveblog/">%s</a> by <a href="http://crowdfavorite.com" title="Custom WordPress development, design and consulting services." rel="developer designer">%s</a>', 'carrington-text'), 'FaveText', 'Crowd Favorite'); ?></p>
<?php
}
?>
